...
public:
  ...
  window *CreateWind(int wd, int h, int x,
                     int y) const; // Creates user interface window
  ...
  void DrawINVERTER(GraphicsInfo r_GfxInfo, bool selected = false,
                    string label = "") const;
  void DrawAND3(GraphicsInfo r_GfxInfo, bool selected = false,
                string label = "") const;
  void DrawNOR3(GraphicsInfo r_GfxInfo, bool selected = false,
                string label = "") const;
  void DrawXOR3(GraphicsInfo r_GfxInfo, bool selected = false,
                string label = "") const;
  void DrawSWITCH(GraphicsInfo r_GfxInfo, bool selected = false,
                  string label = "", bool isOn = false) const;
  void DrawLED(GraphicsInfo r_GfxInfo, bool selected = false, string label = "",
               bool isOn = false) const;

  /// TODO: Make similar functions for drawing all other gates, switch, and LED,
  /// .. etc
