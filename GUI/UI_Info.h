...
struct UI_Info // User Interface Info.
{
  ...
  static const int width = 1400, height = 600, // Window width and height
      wx = 15, wy = 15,                        // Window starting coordinates
      StatusBarHeight = 50,                    // Status Bar Height
      ToolBarHeight = 70, // Tool Bar Height (distance from top of window to
                          // bottom line of toolbar)
  ...
  // This should be calculated accurately because it will be used later to
  // create connections between gates For now, we will assume that rect width =
  // 50 and height = 50
  static const int AND2_Width = 50, // AND2 Gate Image default width
      ...
      SWITCH_Width = 50,            // Switch Image default width
